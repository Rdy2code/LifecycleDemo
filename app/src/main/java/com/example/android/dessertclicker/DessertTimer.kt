...
//Make this class a Lifecycle observer to know about activity and fragment lifecycle
//Constructor takes a Lifecycle object and implements the LO interface
class DessertTimer(lifecycle: Lifecycle): LifecycleObserver {
    ...
    //Connect the lifecycle object from the owner to this class, the observer
    init {
        lifecycle.addObserver(this)
    }

    //Add annotation to tell class what lifecycle events to observe in association with this method
